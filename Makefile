...
#                                                 +#+#+#+#+#+   +#+            #
#    Created: 2022/10/22 19:59:27 by ssonmez           #+#    #+#              #
#    Updated: 2022/11/13 19:53:14 by ssonmez          ###   ########.fr        #
#                                                                              #
# **************************************************************************** #



SRCS			=	ft_isalnum.c ft_isprint.c ft_memcmp.c ft_strchr.c \
					ft_strlcat.c ft_strncmp.c ft_atoi.c ft_isalpha.c \
					ft_strlcpy.c ft_strnstr.c ft_tolower.c ft_bzero.c \
					ft_isascii.c ft_memcpy.c ft_strtrim.c \
